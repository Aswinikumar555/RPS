...
<?php if (isset($_SESSION['username'])){ ?> 
		<body>
			...
			<center>
				<div style="width: 500px;height: 590px;border: 1px solid black;margin-top: 0px;background: #238749; background-image: url('u.jpg');">
					<h4 style="font-size:40px;color: white;text-shadow: 1px 0.7px #000000;margin-top: 10px">Enter Marks</h4>
						<form method="post" action="slave.php">
